...
const edgeColors: Record<string, string> = { led_to: '#5B7553', related_to: '#8B9B85', contradicts: '#A07060', expanded_on: '#6B8BA5' }
const edgeLabels: Record<string, string> = { led_to: 'grew into', related_to: 'related', contradicts: 'diverged', expanded_on: 'branched' }
export function TopicEdge({ sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, data, markerEnd }: EdgeProps) {
  ...
  return (<>
    <BaseEdge path={edgePath} markerEnd={markerEnd} style={{ stroke: color, strokeWidth: 2, strokeDasharray: dashArray, strokeLinecap: 'square' }} />
    <EdgeLabelRenderer>
